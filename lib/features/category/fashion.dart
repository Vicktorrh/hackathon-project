...
class FashionProduct extends StatefulWidget {
  const FashionProduct({super.key});

  @override
  State<FashionProduct> createState() => _FashionProductState();
}

class _FashionProductState extends State<FashionProduct> {
  @override
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      var fashionProducts = listOfDoc
                          .where((element) =>
                              element.data()['productCategory'] == 'Fashion')
                          .toList();
